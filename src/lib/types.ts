...
export type Plan={id:string;title:string;priority:Priority;success_criteria:string;task_estimated_minutes:number;task_count:number;completed_count:number}
...
export type Action={id:string;task_id:string;task_title:string;started_at:string;ended_at:string;actual_minutes:number;note:string}
